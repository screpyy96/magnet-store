    ...
    <div className="mt-4">
      {!isSubscribed ? (
        <button
          ...
          className="px-4 py-2 bg-gradient-to-r from-pink-400 to-amber-400 text-white rounded-md hover:from-pink-500 hover:to-amber-500 disabled:opacity-70"
        >
          {isSubscribing ? 'Se procesează...' : 'Activează notificările'}
        </button>
      ) : (
